        ...
        <div class="col-12">
            <div class="card" style="background-color: #ffffff; border: 1px solid #808080;">
                ...
                <div class="card-body" style="background-color: #ffffff;">
                    <form action="{{ route('admin.psicologia.update', $psicologia) }}" method="POST" id="psicologiaForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control @error('afiliado_id') is-invalid @enderror" id="afiliado_id" name="afiliado_id" required style="border: 1px solid #808080; color: #000000;">
                                    ...
                                    @foreach($afiliados as $afiliado)
                                        <option value="{{ $afiliado->id }}" {{ old('afiliado_id', $psicologia->afiliado_id) == $afiliado->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="date" class="form-control @error('fecha_registro') is-invalid @enderror" id="fecha_registro" name="fecha_registro" value="{{ old('fecha_registro', $psicologia->fecha_registro->format('Y-m-d')) }}" required style="border: 1px solid #808080; color: #000000;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <textarea class="form-control" id="estado_emocional" name="estado_emocional" rows="2" style="border: 1px solid #808080; color: #000000;">{{ old('estado_emocional', $psicologia->estado_emocional) }}</textarea>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="conducta" class="form-label" style="color: #000000;">Conducta</label>
                                <textarea class="form-control" id="conducta" name="conducta" rows="2" style="border: 1px solid #808080; color: #000000;">{{ old('conducta', $psicologia->conducta) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="riesgo_detectado" name="riesgo_detectado" value="1" {{ old('riesgo_detectado', $psicologia->riesgo_detectado) ? 'checked' : '' }} style="border: 1px solid #808080;">
                        ...
                        <div class="row" id="bloqueEvaluacion" style="display: none;">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('diagnostico_inicial') is-invalid @enderror" id="diagnostico_inicial" name="diagnostico_inicial" rows="3" style="border: 1px solid #808080; color: #000000;">{{ old('diagnostico_inicial', $psicologia->diagnostico_inicial) }}</textarea>
                        ...
                        <div class="row" id="bloqueSeguimiento" style="display: none;">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('evolucion') is-invalid @enderror" id="evolucion" name="evolucion" rows="3" style="border: 1px solid #808080; color: #000000;">{{ old('evolucion', $psicologia->evolucion) }}</textarea>
                                @error('evolucion')
                                    <div class="invalid-feedback" style="color: #dc3545;">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control" id="observaciones" name="observaciones" rows="3" style="border: 1px solid #808080; color: #000000;">{{ old('observaciones', $psicologia->observaciones) }}</textarea>
                            </div>
                        </div>
