                                ...
                                @forelse($alertas as $alerta)
                                    <tr>
                                        ...
                                        <td style="color: #000000; border: 1px solid #808080;">
                                            {{ $alerta->psicologia->tipo_label }} - {{ $alerta->psicologia->fecha_registro->format('d/m/Y') }}
                                        </td>
                                        ...
                                        <td style="color: #000000; border: 1px solid #808080;">
                                            <a href="{{ route('admin.psicologia.show', $alerta->psicologia) }}" class="btn btn-sm" style="background-color: #dc3545; color: #ffffff; border: 1px solid #808080;">
