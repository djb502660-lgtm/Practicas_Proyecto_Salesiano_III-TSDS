                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('segundo_nombre') is-invalid @enderror" id="segundo_nombre" name="segundo_nombre" value="{{ old('segundo_nombre') }}" style="border: 1px solid #808080; color: #000000;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('segundo_apellido') is-invalid @enderror" id="segundo_apellido" name="segundo_apellido" value="{{ old('segundo_apellido') }}" style="border: 1px solid #808080; color: #000000;">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-control @error('tipo_documento') is-invalid @enderror" id="tipo_documento" name="tipo_documento" style="border: 1px solid #808080; color: #000000;">
                                            ...
                                            <option value="cedula_extranjeria" {{ old('tipo_documento') == 'cedula_extranjeria' ? 'selected' : '' }}>Cedula de extranjeria</option>
                                        </select>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nacionalidad') is-invalid @enderror" id="nacionalidad" name="nacionalidad" value="{{ old('nacionalidad') }}" style="border: 1px solid #808080; color: #000000;">
                                        @error('nacionalidad')
                                            <div class="invalid-feedback" style="color: #dc3545;">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('edad') is-invalid @enderror" id="edad" name="edad" value="{{ old('edad') }}" min="0" style="border: 1px solid #808080; color: #000000;">
                                        @error('edad')
                                            <div class="invalid-feedback" style="color: #dc3545;">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-8 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('lugar_nacimiento') is-invalid @enderror" id="lugar_nacimiento" name="lugar_nacimiento" value="{{ old('lugar_nacimiento') }}" style="border: 1px solid #808080; color: #000000;">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-control @error('estado_civil') is-invalid @enderror" id="estado_civil" name="estado_civil" style="border: 1px solid #808080; color: #000000;">
                                            ...
                                            <option value="union_libre" {{ old('estado_civil') == 'union_libre' ? 'selected' : '' }}>Union libre</option>
                                        </select>
                                        @error('estado_civil')
                                            <div class="invalid-feedback" style="color: #dc3545;">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('contacto_telefonico') is-invalid @enderror" id="contacto_telefonico" name="contacto_telefonico" value="{{ old('contacto_telefonico') }}" style="border: 1px solid #808080; color: #000000;">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('telefono') is-invalid @enderror" id="telefono" name="telefono" value="{{ old('telefono') }}" style="border: 1px solid #808080; color: #000000;">
                                        @error('telefono')
                                            <div class="invalid-feedback" style="color: #dc3545;">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('celular') is-invalid @enderror" id="celular" name="celular" value="{{ old('celular') }}" style="border: 1px solid #808080; color: #000000;">
                                        @error('celular')
                                            <div class="invalid-feedback" style="color: #dc3545;">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 mb-3">
                                        ...
                                        <textarea class="form-control @error('direccion_domicilio') is-invalid @enderror" id="direccion_domicilio" name="direccion_domicilio" rows="2" style="border: 1px solid #808080; color: #000000;">{{ old('direccion_domicilio') }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('sector_barrio') is-invalid @enderror" id="sector_barrio" name="sector_barrio" value="{{ old('sector_barrio') }}" style="border: 1px solid #808080; color: #000000;">
                                        @error('sector_barrio')
                                            <div class="invalid-feedback" style="color: #dc3545;">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('ciudad_residencia') is-invalid @enderror" id="ciudad_residencia" name="ciudad_residencia" value="{{ old('ciudad_residencia') }}" style="border: 1px solid #808080; color: #000000;">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('parroquia_civil') is-invalid @enderror" id="parroquia_civil" name="parroquia_civil" value="{{ old('parroquia_civil') }}" style="border: 1px solid #808080; color: #000000;">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('departamento_referencia') is-invalid @enderror" id="departamento_referencia" name="departamento_referencia" value="{{ old('departamento_referencia') }}" placeholder="Ej: Cerca de la iglesia" style="border: 1px solid #808080; color: #000000;">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('pais') is-invalid @enderror" id="pais" name="pais" value="{{ old('pais') }}" style="border: 1px solid #808080; color: #000000;">
                                        @error('pais')
                                            <div class="invalid-feedback" style="color: #dc3545;">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-control @error('tiene_discapacidad') is-invalid @enderror" id="tiene_discapacidad" name="tiene_discapacidad" style="border: 1px solid #808080; color: #000000;">
                                            <option value="">Seleccione...</option>
                                            <option value="1" {{ old('tiene_discapacidad') === '1' ? 'selected' : '' }}>Si</option>
                                            <option value="0" {{ old('tiene_discapacidad') === '0' ? 'selected' : '' }}>No</option>
                                        </select>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('porcentaje_discapacidad') is-invalid @enderror" id="porcentaje_discapacidad" name="porcentaje_discapacidad" value="{{ old('porcentaje_discapacidad') }}" min="0" max="100" style="border: 1px solid #808080; color: #000000;">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nombre_conyuge') is-invalid @enderror" id="nombre_conyuge" name="nombre_conyuge" value="{{ old('nombre_conyuge') }}" style="border: 1px solid #808080; color: #000000;">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('numero_hijos') is-invalid @enderror" id="numero_hijos" name="numero_hijos" value="{{ old('numero_hijos', 0) }}" min="0" style="border: 1px solid #808080; color: #000000;">
                                        @error('numero_hijos')
                                            <div class="invalid-feedback" style="color: #dc3545;">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('personas_a_cargo') is-invalid @enderror" id="personas_a_cargo" name="personas_a_cargo" value="{{ old('personas_a_cargo', 0) }}" min="0" style="border: 1px solid #808080; color: #000000;">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('informacion_familiar') is-invalid @enderror" id="informacion_familiar" name="informacion_familiar" rows="3" style="border: 1px solid #808080; color: #000000;">{{ old('informacion_familiar') }}</textarea>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nombre_representante') is-invalid @enderror" id="nombre_representante" name="nombre_representante" value="{{ old('nombre_representante') }}" style="border: 1px solid #808080; color: #000000;">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('apellido_representante') is-invalid @enderror" id="apellido_representante" name="apellido_representante" value="{{ old('apellido_representante') }}" style="border: 1px solid #808080; color: #000000;">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-control @error('tipo_documento_representante') is-invalid @enderror" id="tipo_documento_representante" name="tipo_documento_representante" style="border: 1px solid #808080; color: #000000;">
                                            <option value="">Seleccione...</option>
                                            <option value="cedula" {{ old('tipo_documento_representante') == 'cedula' ? 'selected' : '' }}>Cedula</option>
                                            <option value="pasaporte" {{ old('tipo_documento_representante') == 'pasaporte' ? 'selected' : '' }}>Pasaporte</option>
                                            <option value="tarjeta_identidad" {{ old('tipo_documento_representante') == 'tarjeta_identidad' ? 'selected' : '' }}>Tarjeta de identidad</option>
                                            <option value="cedula_extranjeria" {{ old('tipo_documento_representante') == 'cedula_extranjeria' ? 'selected' : '' }}>Cedula de extranjeria</option>
                                        </select>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('numero_documento_representante') is-invalid @enderror" id="numero_documento_representante" name="numero_documento_representante" value="{{ old('numero_documento_representante') }}" style="border: 1px solid #808080; color: #000000;">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('parentesco') is-invalid @enderror" id="parentesco" name="parentesco" value="{{ old('parentesco') }}" style="border: 1px solid #808080; color: #000000;">
                                        @error('parentesco')
                                            <div class="invalid-feedback" style="color: #dc3545;">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('edad_representante') is-invalid @enderror" id="edad_representante" name="edad_representante" value="{{ old('edad_representante') }}" min="0" style="border: 1px solid #808080; color: #000000;">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nivel_estudio') is-invalid @enderror" id="nivel_estudio" name="nivel_estudio" value="{{ old('nivel_estudio') }}" style="border: 1px solid #808080; color: #000000;">
                                        @error('nivel_estudio')
                                            <div class="invalid-feedback" style="color: #dc3545;">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('ocupacion') is-invalid @enderror" id="ocupacion" name="ocupacion" value="{{ old('ocupacion') }}" style="border: 1px solid #808080; color: #000000;">
                                        @error('ocupacion')
                                            <div class="invalid-feedback" style="color: #dc3545;">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('lugar_trabajo') is-invalid @enderror" id="lugar_trabajo" name="lugar_trabajo" value="{{ old('lugar_trabajo') }}" style="border: 1px solid #808080; color: #000000;">
                                        @error('lugar_trabajo')
                                            <div class="invalid-feedback" style="color: #dc3545;">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select class="form-control @error('tipo_empleo') is-invalid @enderror" id="tipo_empleo" name="tipo_empleo" style="border: 1px solid #808080; color: #000000;">
                                            <option value="">Seleccione...</option>
                                            <option value="permanente" {{ old('tipo_empleo') == 'permanente' ? 'selected' : '' }}>Permanente</option>
                                            <option value="ocasional" {{ old('tipo_empleo') == 'ocasional' ? 'selected' : '' }}>Ocasional</option>
                                        </select>
                                        @error('tipo_empleo')
                                            <div class="invalid-feedback" style="color: #dc3545;">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control @error('ingresos_mensuales') is-invalid @enderror" id="ingresos_mensuales" name="ingresos_mensuales" value="{{ old('ingresos_mensuales') }}" min="0" style="border: 1px solid #808080; color: #000000;">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('jornada_laboral') is-invalid @enderror" id="jornada_laboral" name="jornada_laboral" value="{{ old('jornada_laboral') }}" style="border: 1px solid #808080; color: #000000;">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('dias_laborales') is-invalid @enderror" id="dias_laborales" name="dias_laborales" value="{{ old('dias_laborales') }}" style="border: 1px solid #808080; color: #000000;">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('horario_trabajo') is-invalid @enderror" id="horario_trabajo" name="horario_trabajo" value="{{ old('horario_trabajo') }}" style="border: 1px solid #808080; color: #000000;">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-control @error('estudia') is-invalid @enderror" id="estudia" name="estudia" style="border: 1px solid #808080; color: #000000;">
                                            <option value="">Seleccione...</option>
                                            <option value="1" {{ old('estudia') === '1' ? 'selected' : '' }}>Si</option>
                                            <option value="0" {{ old('estudia') === '0' ? 'selected' : '' }}>No</option>
                                        </select>
                                        @error('estudia')
                                            <div class="invalid-feedback" style="color: #dc3545;">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-control @error('nivel_educativo') is-invalid @enderror" id="nivel_educativo" name="nivel_educativo" style="border: 1px solid #808080; color: #000000;">
                                            <option value="">Seleccione...</option>
                                            <option value="inicial" {{ old('nivel_educativo') == 'inicial' ? 'selected' : '' }}>Inicial</option>
                                            <option value="basica" {{ old('nivel_educativo') == 'basica' ? 'selected' : '' }}>Basica</option>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-control @error('institucion_educativa') is-invalid @enderror" id="institucion_educativa" name="institucion_educativa" style="border: 1px solid #808080; color: #000000;">
                                            ...
                                            @foreach($instituciones as $institucion)
                                                <option value="{{ $institucion }}" {{ old('institucion_educativa') == $institucion ? 'selected' : '' }}>{{ $institucion }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('ultimo_anio_aprobado') is-invalid @enderror" id="ultimo_anio_aprobado" name="ultimo_anio_aprobado" value="{{ old('ultimo_anio_aprobado') }}" style="border: 1px solid #808080; color: #000000;">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('representante_legal') is-invalid @enderror" id="representante_legal" name="representante_legal" value="{{ old('representante_legal') }}" style="border: 1px solid #808080; color: #000000;">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-control @error('tiene_seguro_salud') is-invalid @enderror" id="tiene_seguro_salud" name="tiene_seguro_salud" style="border: 1px solid #808080; color: #000000;">
                                            <option value="">Seleccione...</option>
                                            <option value="1" {{ old('tiene_seguro_salud') === '1' ? 'selected' : '' }}>Si</option>
                                            <option value="0" {{ old('tiene_seguro_salud') === '0' ? 'selected' : '' }}>No</option>
                                        </select>
                                    ...
                                    <div class="col-md-8 mb-3">
                                        ...
                                        <select class="form-control @error('tipo_seguro_salud') is-invalid @enderror" id="tipo_seguro_salud" name="tipo_seguro_salud" style="border: 1px solid #808080; color: #000000;">
                                            ...
                                            @foreach($seguros as $value => $label)
                                                <option value="{{ $value }}" {{ old('tipo_seguro_salud') == $value ? 'selected' : '' }}>{{ $label }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('eps') is-invalid @enderror" id="eps" name="eps" value="{{ old('eps') }}" style="border: 1px solid #808080; color: #000000;">
                                        @error('eps')
                                            <div class="invalid-feedback" style="color: #dc3545;">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <textarea class="form-control @error('condiciones_medicas') is-invalid @enderror" id="condiciones_medicas" name="condiciones_medicas" rows="2" style="border: 1px solid #808080; color: #000000;">{{ old('condiciones_medicas') }}</textarea>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <textarea class="form-control @error('medicamentos_permanentes') is-invalid @enderror" id="medicamentos_permanentes" name="medicamentos_permanentes" rows="2" style="border: 1px solid #808080; color: #000000;">{{ old('medicamentos_permanentes') }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <textarea class="form-control @error('alergias') is-invalid @enderror" id="alergias" name="alergias" rows="2" style="border: 1px solid #808080; color: #000000;">{{ old('alergias') }}</textarea>
                                        @error('alergias')
                                            <div class="invalid-feedback" style="color: #dc3545;">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <textarea class="form-control @error('observaciones') is-invalid @enderror" id="observaciones" name="observaciones" rows="2" style="border: 1px solid #808080; color: #000000;">{{ old('observaciones') }}</textarea>
                                        @error('observaciones')
                                            <div class="invalid-feedback" style="color: #dc3545;">{{ $message }}</div>
                                        @enderror
                                    </div>
