                    ...
                    <div class="card-header" style="background-color: #ffffff; border-bottom: 1px solid #808080;">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.roles.create') }}" class="btn"
                                ...
                                <i class="ri-add-line" style="color: #ffffff;"></i> Nuevo Rol
                            </a>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td style="color: #000000; border: 1px solid #808080;">
                                                @foreach($role->permissions as $permission)
                                                    <span class="badge"
                                                        style="background-color: #dc3545; color: #ffffff; border: 1px solid #808080; margin-right: 4px;">{{ $permission->name }}</span>
                                                @endforeach
                                            </td>
                                            <td style="color: #000000; border: 1px solid #808080;">
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route('admin.roles.show', $role) }}" class="btn btn-sm"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5" class="text-center"
                                                style="color: #000000; border: 1px solid #808080;">No hay roles registrados.
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
