            ...
            <div class="authentication-inner">
                <div class="card" style="background-color: #ffffff; border: 1px solid #808080;">
                    <div class="card-body" style="background-color: #ffffff;">
                        ...
                        <p class="mb-4" style="color: #000000; text-align: center;">Por favor inicia sesión en tu cuenta
                        </p>
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('email') is-invalid @enderror" id="email"
                                    name="email" placeholder="Ingresa tu email" autofocus value="{{ old('email') }}"
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="remember" style="color: #000000;"> Recordarme
                                    </label>
                                </div>
                            </div>
                            <div class="mb-3">
